...
/// What one part was built with that its core's TRM leaves to it: the level 1 caches of the M7, M55 and M85, the M7 TCMs, AHBP and ECC of M7 TRM Table 1-1, the MPU and SAU region counts, the priority bits, the external interrupts, and the REVIDRNUM the M55 and M85 read in REVIDR, M55 and M85 TRM 5.7; a core that carries none ignores them, and a value left null is the core's default.
